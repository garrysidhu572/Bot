...
$botToken = "6478073504:AAHSesfBvVHIVYvbbZ16Rk7lKhEsqrySzRw";
...
$keyboard = json_encode([
    'inline_keyboard' => [
        [
            ['text' => "Owner 👨‍💻", 'url' => "https://t.me/PUNJAB_BUY"],
            ['text' => "Buy 💰", 'url' => "https://t.me/PUNJAB_BUY"],
        ],
    ]
]);
...
if ($cdata2 == "back") {
    ...
    $gatesText = "<b>━━━━━━━━━━━━━━━━━━━\n" 
               ...
               . str_repeat(' ', 20) 
               . "\n━━━━━━━━━━━━━━━━━━━\n •├𝗧𝗼𝘁𝗮𝗹  𝗚𝗔𝗧𝗘𝗦 ⇢ 9\n •├𝗣𝗥𝗘𝗠𝗜𝗨𝗠  𝗚𝗔𝗧𝗘𝗦 ⇢ 5 \n •├𝗙𝗥𝗘𝗘 𝗚𝗔𝗧𝗘𝗦 ⇢ 4\n\n━━━━━━━━━━━━━━━━━━━\n •├Dev ➳ <code>@PUNJAB_BUY</code></b>";

    $gatesKeyboard = json_encode([
        'inline_keyboard' => [
            [['text' => 'Premium', 'callback_data' => 'premium'], ['text' => 'Free', 'callback_data' => 'free']],
            [['text' => 'Back', 'callback_data' => 'back2']]
        ]
    ]);
...
$toolKeyboard = json_encode([
    'inline_keyboard' => [
        [['text' => "Gates", 'callback_data' => 'gates'], ['text' => "Back", 'callback_data' => 'back2']]
    ]
]);
...
if ($cdata2 == "price") {
    ...
    $priceKeyboard = json_encode([
        'inline_keyboard' => [
            [['text' => 'Home', 'callback_data' => 'back2'], ['text' => 'Buy', 'url' => 'https://t.me/PUNJAB_BUY']]
        ]
    ]);
...
$channel = json_encode([
    'inline_keyboard' => [
        [['text' => "Group", 'url' => "https://t.me/+R7w7BqReA9NjMTJl"], ['text' => "Channel", 'url' => "https://t.me/GARRYPLAYS"]],
        [['text' => "Back", 'callback_data' => 'back2']]
    ]
]);

if ($cdata2 == "channel") {
    $channelText = "<b>Join Our Official Group And Channel</b>";
...
//==========back and close========//
if ($cdata2 == "back2") {
    $backtxt = ("<b>Welcome To My Commands Section $firstname
    
Explore Me More By Clicking The Buttons Below</b>");
    
    // Change this to your video url
    $backVideoUrl = "https://t.me/igppd/3782"; 
